 ...
 */
final class LinePatternRecognizer implements PatternRecognizer, DefaultPatternRecognizerParameters {
    ...
    @Override
    public final DefaultPatternRecognizerParameters setMaxAreaRatio(final double aMaxAreaRatio) {
        maxAreaRatio = aMaxAreaRatio;
        return this;
    }

    @Override
    public final DefaultPatternRecognizerParameters setMinCorrelation(final double aMinCorrelation) {
