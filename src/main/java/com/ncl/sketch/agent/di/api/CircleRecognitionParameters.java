...
public interface CircleRecognitionParameters extends LineRecognitionParameters {
    ...
    /**
     * Returns the maximum error between the feature area of this stroke to the candidate circle center and the
     * candidate circle area above which the candidate circle will be considered unacceptable. This is a
     * {@code double} in range <i>0.0</i> to <i>1.0</i> with a low value (typically <i>0.1</i>)
     */
    @Override
    double maxAreaError();
     ...
     * used to assess the fit of the computed regression line derived from the direction graph of the stroke. The
    ...
    /**
     * Sets the maximum error between the feature area of this stroke to the candidate circle center and the
     * candidate circle area above which the candidate circle will be considered unacceptable. This is a
     * {@code double} in range <i>0.0</i> to <i>1.0</i> with a low value (typically <i>0.1</i>)
     *
     * @param maxAreaError the maximum area error
    ...
    /**
     * Sets the minimum correlation. Minimum correlation is Minimum correlation is a {@code double} in range
     * <i>0.0</i> to <i>1.0</i> used to assess the fit of the computed regression line derived from the direction
     * graph of the stroke. The higher the value the more restrictive the fit will be
     *
